...
import org.selurgniman.forge.comparableconversion.ChatColor;
...
public enum Message {
	...
	NPCMOD_ENABLED_MESSAGE("messages", "enabled", ChatColor.GREEN+"Enabled!"+ChatColor.RESET),
    NPCMOD_DISABLED_MESSAGE("messages", "disabled", ChatColor.RED+"Disabled!"+ChatColor.RESET),
